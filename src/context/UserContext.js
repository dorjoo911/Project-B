...
export const UserStore = (props) => {
  ...
  const autoRenewTokenAfterMillisec = (milliSec) => {
    ...
    axios
      .post(
        "https://securetoken.googleapis.com/v1/token?key=AIzaSyC0N0EHElAbM2-Thze87O_nOoW59EFhaKg",
  ...
  const loginUser = (email, password) => {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC0N0EHElAbM2-Thze87O_nOoW59EFhaKg",
        data
      )
      .then((result) => {
